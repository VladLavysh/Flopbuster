...
export const POLLINATIONS_IMAGE_HINT =
  "Poster art is generated by pollinations.ai — it can be slow or briefly unavailable. The image will appear when ready.";

export function isPollinationsUrl(url: string): boolean {
